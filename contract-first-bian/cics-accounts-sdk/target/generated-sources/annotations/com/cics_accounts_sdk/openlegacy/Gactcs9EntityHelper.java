...
final class Gactcs9EntityHelper {
    ...
    static {
        entityDefinition = new org.openlegacy.core.model.entity.RpcEntityDefinitionImpl(
                "cf9b92cb-58ae-4aca-8992-33b3849d5f7b",
                "Gactcs9",
                "com.cics_accounts_sdk.openlegacy.Gactcs9",
                "Gactcs9",
                ...
                "inPut",
                "com.cics_accounts_sdk.openlegacy.Gactcs9InPut",
                "INPUT",
                ...
                "accountOut",
                "com.cics_accounts_sdk.openlegacy.Gactcs9AccountOut",
                "ACCOUNTOUT",
                "org.openlegacy.core.model.field.RpcFieldType.General",
                false,
                229,
                ...
                "accountDetails2",
                "com.cics_accounts_sdk.openlegacy.Gactcs9AccountDetails2",
                "ACCOUNTDETAILS2",
                "org.openlegacy.core.model.field.RpcFieldType.General",
                false,
                169,
    ...
    private static Gactcs9InPut fromGactcs9InPutJsonObject(JsonObject jsonObject,
            Gactcs9InPut inPut) {
        inPut.setActiAccountId(jsonObject.getString("actiAccountId"));
        return inPut;
    }

    private static Gactcs9AccountDetails2 fromGactcs9AccountDetails2JsonObject(
            JsonObject jsonObject, Gactcs9AccountDetails2 accountDetails2) {
    ...
    private static Gactcs9AccountOut fromGactcs9AccountOutJsonObject(JsonObject jsonObject,
            Gactcs9AccountOut accountOut) {
        JsonObject accountDetails2Object = jsonObject.getJsonObject("accountDetails2");
        if (accountDetails2Object != null) {
            accountOut.setAccountDetails2(fromGactcs9AccountDetails2JsonObject(accountDetails2Object, new Gactcs9AccountDetails2()));
        }
        accountOut.setRtMsg(jsonObject.getString("rtMsg"));
        return accountOut;
    }

    public static void populateFromJson(@NotNull JsonObject jsonObject, @NotNull Gactcs9 entity) {
        Objects.requireNonNull(entity, "provided entity should not be null");
        if (jsonObject != null) {
            JsonObject inPutObject = jsonObject.getJsonObject("inPut");
            if (inPutObject != null) {
                entity.setInPut(fromGactcs9InPutJsonObject(inPutObject, new Gactcs9InPut()));
            }
            JsonObject accountOutObject = jsonObject.getJsonObject("accountOut");
            if (accountOutObject != null) {
                entity.setAccountOut(fromGactcs9AccountOutJsonObject(accountOutObject, new Gactcs9AccountOut()));
            }
        }
    }

    private static JsonObject initGactcs9InPut(Gactcs9InPut object) {
        JsonObject jsonObject = new JsonObject();
        jsonObject.put("actiAccountId", object.getActiAccountId());
        return jsonObject;
    }

    private static JsonObject initGactcs9AccountDetails2(Gactcs9AccountDetails2 object) {
        JsonObject jsonObject = new JsonObject();
    ...
    private static JsonObject initGactcs9AccountOut(Gactcs9AccountOut object) {
        JsonObject jsonObject = new JsonObject();
        Gactcs9AccountDetails2 accountDetails2 = object.getAccountDetails2();
        if (accountDetails2 != null) {
            jsonObject.put("accountDetails2", initGactcs9AccountDetails2(accountDetails2));
        } else {
    ...
    public static JsonObject toJson(Gactcs9 entity) {
        JsonObject jsonObject = new JsonObject();
        if (entity != null) {
            Gactcs9InPut inPut = entity.getInPut();
            if (inPut != null) {
                jsonObject.put("inPut", initGactcs9InPut(inPut));
            } else {
                jsonObject.put("inPut", (Object) null);
            }
            Gactcs9AccountOut accountOut = entity.getAccountOut();
            if (accountOut != null) {
                jsonObject.put("accountOut", initGactcs9AccountOut(accountOut));
            } else {
