...
@Getter
@Setter
@Schema(name = "BodyIssuedDeviceInstanceRecordIssuedDeviceProperty")
public class BodyIssuedDeviceInstanceRecordIssuedDeviceProperty {

    @Valid
    @JsonProperty("issuedDevicePropertyType")
    @Schema(name = "issuedDevicePropertyType")
    private BodyIssuedDeviceInstanceRecordIssuedDevicePropertyIssuedDevicePropertyType issuedDevicePropertyType;
