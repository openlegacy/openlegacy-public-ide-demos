 ...
 *  The interface ExecuteCurrentAccountFulfillmentArrangementDepositsAndWithdrawalsUpdateService can be customized to enabling passing parameters to the service.
 */

@Service(name = "ExecuteCurrentAccountFulfillmentArrangementDepositsAndWithdrawalsUpdate")
@OpenlegacyDesigntime(editor = "WebServiceEditor")
public interface ExecuteCurrentAccountFulfillmentArrangementDepositsAndWithdrawalsUpdateService {
    ...
    @Getter
    @Setter
    public static class ExecuteCurrentAccountFulfillmentArrangementDepositsAndWithdrawalsUpdateIn {
    ...
    @Schema(name = "ExecuteCurrentAccountFulfillmentArrangementDepositsAndWithdrawalsUpdateOut", description = "")
    @Getter
    @Setter
    public static class ExecuteCurrentAccountFulfillmentArrangementDepositsAndWithdrawalsUpdateOut {

        @Schema(description = "response200")
        @ServiceField(restOutput = true, description = "Successful execution of DepositsAndWithdrawals Instance Record")
