 ...
 *  The interface InitiateCurrentAccountFulfillmentArrangementServiceFeesService can be customized to enabling passing parameters to the service.
 */

@Service(name = "InitiateCurrentAccountFulfillmentArrangementServiceFees")
@OpenlegacyDesigntime(editor = "WebServiceEditor")
public interface InitiateCurrentAccountFulfillmentArrangementServiceFeesService {
    ...
    @Getter
    @Setter
    public static class InitiateCurrentAccountFulfillmentArrangementServiceFeesIn {
    ...
    @Schema(name = "InitiateCurrentAccountFulfillmentArrangementServiceFeesOut", description = "")
    @Getter
    @Setter
    public static class InitiateCurrentAccountFulfillmentArrangementServiceFeesOut {
