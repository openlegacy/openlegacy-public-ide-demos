 ...
 *  The interface InitiateCurrentAccountFulfillmentArrangementPaymentsService can be customized to enabling passing parameters to the service.
 */

@Service(name = "InitiateCurrentAccountFulfillmentArrangementPayments")
@OpenlegacyDesigntime(editor = "WebServiceEditor")
public interface InitiateCurrentAccountFulfillmentArrangementPaymentsService {

    public InitiateCurrentAccountFulfillmentArrangementPaymentsOut initiateCurrentAccountFulfillmentArrangementPayments(InitiateCurrentAccountFulfillmentArrangementPaymentsIn initiateCurrentAccountFulfillmentArrangementPaymentsIn) throws Exception;

    @Getter
    @Setter
    public static class InitiateCurrentAccountFulfillmentArrangementPaymentsIn {
    ...
    @Schema(name = "InitiateCurrentAccountFulfillmentArrangementPaymentsOut", description = "")
    @Getter
    @Setter
    public static class InitiateCurrentAccountFulfillmentArrangementPaymentsOut {
