...
@Getter
@Setter
@Schema(name = "BodyPaymentsInstanceRecordPaymentConfiguration")
public class BodyPaymentsInstanceRecordPaymentConfiguration {
    ...
    private BodyPaymentsInstanceRecordPaymentConfigurationDirectDebitMandateReference directDebitMandateReference;

    @Valid
    @JsonProperty("billPayMandateReference")
    @Schema(name = "billPayMandateReference")
    private BodyPaymentsInstanceRecordPaymentConfigurationBillPayMandateReference billPayMandateReference;
}
