...
@Getter
@Setter
@Schema(name = "Response200PaymentsInstanceRecord")
public class Response200PaymentsInstanceRecord {
    ...
    private Response200PaymentsInstanceRecordPaymentConfiguration paymentConfiguration;

    @Valid
    @JsonProperty("paymentTransaction")
    @Schema(name = "paymentTransaction")
    private Response200PaymentsInstanceRecordPaymentTransaction paymentTransaction;
}
