 ...
 *  The interface InitiateCurrentAccountFulfillmentArrangementAccountLienService can be customized to enabling passing parameters to the service.
 */

@Service(name = "InitiateCurrentAccountFulfillmentArrangementAccountLien")
@OpenlegacyDesigntime(editor = "WebServiceEditor")
public interface InitiateCurrentAccountFulfillmentArrangementAccountLienService {

    public InitiateCurrentAccountFulfillmentArrangementAccountLienOut initiateCurrentAccountFulfillmentArrangementAccountLien(InitiateCurrentAccountFulfillmentArrangementAccountLienIn initiateCurrentAccountFulfillmentArrangementAccountLienIn) throws Exception;

    @Getter
    @Setter
    public static class InitiateCurrentAccountFulfillmentArrangementAccountLienIn {
    ...
    @Schema(name = "InitiateCurrentAccountFulfillmentArrangementAccountLienOut", description = "")
    @Getter
    @Setter
    public static class InitiateCurrentAccountFulfillmentArrangementAccountLienOut {
