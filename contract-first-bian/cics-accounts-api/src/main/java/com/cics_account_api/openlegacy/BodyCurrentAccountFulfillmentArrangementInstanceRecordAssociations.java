...
@Getter
@Setter
@Schema(name = "BodyCurrentAccountFulfillmentArrangementInstanceRecordAssociations")
public class BodyCurrentAccountFulfillmentArrangementInstanceRecordAssociations {
