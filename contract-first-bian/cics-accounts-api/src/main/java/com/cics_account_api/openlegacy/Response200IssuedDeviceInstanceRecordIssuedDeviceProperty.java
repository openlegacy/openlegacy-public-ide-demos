...
@Getter
@Setter
@Schema(name = "Response200IssuedDeviceInstanceRecordIssuedDeviceProperty")
public class Response200IssuedDeviceInstanceRecordIssuedDeviceProperty {

    @Valid
    @JsonProperty("issuedDevicePropertyType")
    @Schema(name = "issuedDevicePropertyType")
    private Response200IssuedDeviceInstanceRecordIssuedDevicePropertyIssuedDevicePropertyType issuedDevicePropertyType;
