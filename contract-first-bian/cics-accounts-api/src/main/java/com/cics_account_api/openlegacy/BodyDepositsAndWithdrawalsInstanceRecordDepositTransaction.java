...
@Getter
@Setter
@Schema(name = "BodyDepositsAndWithdrawalsInstanceRecordDepositTransaction")
public class BodyDepositsAndWithdrawalsInstanceRecordDepositTransaction {

    @JsonProperty("depositTransactionSourceReference")
    @Schema(description = "`status: Not Mapped`\n core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier\n general-info: Identifies the source of the deposit\n", example = "717014", name = "depositTransactionSourceReference")
