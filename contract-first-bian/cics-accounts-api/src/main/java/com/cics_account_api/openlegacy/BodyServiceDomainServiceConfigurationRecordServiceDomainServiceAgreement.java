...
@Getter
@Setter
@Schema(name = "BodyServiceDomainServiceConfigurationRecordServiceDomainServiceAgreement")
public class BodyServiceDomainServiceConfigurationRecordServiceDomainServiceAgreement {
