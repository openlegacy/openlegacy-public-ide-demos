 ...
 *  The interface UpdateCurrentAccountFulfillmentArrangementIssuedDeviceService can be customized to enabling passing parameters to the service.
 */

@Service(name = "UpdateCurrentAccountFulfillmentArrangementIssuedDevice")
@OpenlegacyDesigntime(editor = "WebServiceEditor")
public interface UpdateCurrentAccountFulfillmentArrangementIssuedDeviceService {
    ...
    @Getter
    @Setter
    public static class UpdateCurrentAccountFulfillmentArrangementIssuedDeviceIn {
    ...
    @Schema(name = "UpdateCurrentAccountFulfillmentArrangementIssuedDeviceOut", description = "")
    @Getter
    @Setter
    public static class UpdateCurrentAccountFulfillmentArrangementIssuedDeviceOut {

        @Schema(description = "response200")
        @ServiceField(restOutput = true, description = "Successfully Updated IssuedDevice Instance")
