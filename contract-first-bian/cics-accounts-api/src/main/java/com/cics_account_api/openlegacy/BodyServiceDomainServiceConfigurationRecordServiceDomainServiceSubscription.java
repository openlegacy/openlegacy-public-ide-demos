...
@Getter
@Setter
@Schema(name = "BodyServiceDomainServiceConfigurationRecordServiceDomainServiceSubscription")
public class BodyServiceDomainServiceConfigurationRecordServiceDomainServiceSubscription {
