...
@Getter
@Setter
@Schema(name = "BodyIssuedDeviceInstanceRecord")
public class BodyIssuedDeviceInstanceRecord {
    ...
    private BodyIssuedDeviceInstanceRecordIssuedDeviceProperty issuedDeviceProperty;
}
