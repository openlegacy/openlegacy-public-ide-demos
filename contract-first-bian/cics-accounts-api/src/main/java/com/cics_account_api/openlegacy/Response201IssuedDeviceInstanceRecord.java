...
@Getter
@Setter
@Schema(name = "Response201IssuedDeviceInstanceRecord")
public class Response201IssuedDeviceInstanceRecord {
    ...
    private Response201IssuedDeviceInstanceRecordIssuedDeviceProperty issuedDeviceProperty;
}
