...
@Getter
@Setter
@Schema(name = "Response200AccountSweepInstanceRecord")
public class Response200AccountSweepInstanceRecord {
    ...
    private Response200AccountSweepInstanceRecordAccountSweepConfiguration accountSweepConfiguration;

    @Valid
    @JsonProperty("sweepApplicationRecord")
    @Schema(name = "sweepApplicationRecord")
    private Response200AccountSweepInstanceRecordSweepApplicationRecord sweepApplicationRecord;
}
