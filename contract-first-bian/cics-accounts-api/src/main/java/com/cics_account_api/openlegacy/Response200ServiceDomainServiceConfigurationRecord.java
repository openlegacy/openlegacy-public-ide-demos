...
@Getter
@Setter
@Schema(name = "Response200ServiceDomainServiceConfigurationRecord")
public class Response200ServiceDomainServiceConfigurationRecord {
    ...
    private Response200ServiceDomainServiceConfigurationRecordServiceDomainServiceConfigurationSetup serviceDomainServiceConfigurationSetup;

    @Valid
    @JsonProperty("serviceDomainServiceSubscription")
    @Schema(name = "serviceDomainServiceSubscription")
    private Response200ServiceDomainServiceConfigurationRecordServiceDomainServiceSubscription serviceDomainServiceSubscription;

    @Valid
    @JsonProperty("serviceDomainServiceAgreement")
    @Schema(name = "serviceDomainServiceAgreement")
    private Response200ServiceDomainServiceConfigurationRecordServiceDomainServiceAgreement serviceDomainServiceAgreement;
