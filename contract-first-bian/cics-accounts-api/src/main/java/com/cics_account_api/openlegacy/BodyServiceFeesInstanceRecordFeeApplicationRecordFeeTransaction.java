...
@Getter
@Setter
@Schema(name = "BodyServiceFeesInstanceRecordFeeApplicationRecordFeeTransaction")
public class BodyServiceFeesInstanceRecordFeeApplicationRecordFeeTransaction {
