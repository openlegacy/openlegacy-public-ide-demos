 ...
 *  The interface RequestCurrentAccountFulfillmentArrangementIssuedDeviceUpdateService can be customized to enabling passing parameters to the service.
 */

@Service(name = "RequestCurrentAccountFulfillmentArrangementIssuedDeviceUpdate")
@OpenlegacyDesigntime(editor = "WebServiceEditor")
public interface RequestCurrentAccountFulfillmentArrangementIssuedDeviceUpdateService {
    ...
    @Getter
    @Setter
    public static class RequestCurrentAccountFulfillmentArrangementIssuedDeviceUpdateIn {
        ...
        @ServiceField(location = RestLocation.BODY, description = "IssuedDevice request payload")
        @Valid
        Body body;
    }

    @Schema(name = "RequestCurrentAccountFulfillmentArrangementIssuedDeviceUpdateOut", description = "")
    @Getter
    @Setter
    public static class RequestCurrentAccountFulfillmentArrangementIssuedDeviceUpdateOut {

        @Schema(description = "response200")
        @ServiceField(restOutput = true, description = "Successful requisition of IssuedDevice Instance Record")
