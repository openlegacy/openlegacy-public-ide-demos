...
@Getter
@Setter
@Schema(name = "Response200DepositsAndWithdrawalsInstanceRecordWithdrawalTransaction")
public class Response200DepositsAndWithdrawalsInstanceRecordWithdrawalTransaction {

    @JsonProperty("withdrawalTransactionSourceReference")
    @Schema(description = "`status: Not Mapped`\n core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier\n general-info: Identifies the target for the withdrawal\n", example = "760470", name = "withdrawalTransactionSourceReference")
