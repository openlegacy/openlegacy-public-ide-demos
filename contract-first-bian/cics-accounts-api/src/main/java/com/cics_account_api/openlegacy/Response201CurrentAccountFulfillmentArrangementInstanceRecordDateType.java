...
@Getter
@Setter
@Schema(name = "Response201CurrentAccountFulfillmentArrangementInstanceRecordDateType")
public class Response201CurrentAccountFulfillmentArrangementInstanceRecordDateType {
