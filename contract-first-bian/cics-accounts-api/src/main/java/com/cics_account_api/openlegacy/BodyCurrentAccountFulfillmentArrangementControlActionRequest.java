...
@Getter
@Setter
@Schema(name = "BodyCurrentAccountFulfillmentArrangementControlActionRequest")
public class BodyCurrentAccountFulfillmentArrangementControlActionRequest {

    @JsonProperty("controlActionType")
    @Schema(description = "`status: Not Mapped`\n core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text\n general-info: The type of processing action requested (e.g. suspend, skip, terminate)\n", name = "controlActionType")
