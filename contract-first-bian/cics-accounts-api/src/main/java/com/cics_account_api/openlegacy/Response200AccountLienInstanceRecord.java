...
@Getter
@Setter
@Schema(name = "Response200AccountLienInstanceRecord")
public class Response200AccountLienInstanceRecord {
    ...
    @Schema(description = "`status: Not Mapped`\n core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text\n general-info: Definition of the type of lien including processing guidelines\n", name = "lienDefinition")
    ...
    private Response200AccountLienInstanceRecordLienRecord lienRecord;
}
