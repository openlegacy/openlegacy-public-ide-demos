...
@Getter
@Setter
@RpcEntity(name="OpenAccount", language=Languages.PLSQL)
@RpcActions(actions = {
        @Action(action = EXECUTE.class, path = "OPENLEGACY_TEAM.BANK_ACCOUNTS_PACKAGE.OPEN_ACCOUNT", displayName = "Execute", alias = "execute" )            })
public class OpenAccount implements org.openlegacy.core.rpc.RpcEntity {
    ...
    public RpcEntityDefinition entityDefinition() {
        return OpenAccountEntityHelper.entityDefinition;
    }

    @NotNull
    @Override
    public RpcEntityDefinition inputEntityDefinition() {
        return OpenAccountEntityHelper.inputEntityDefinition;
    }

    @NotNull
    @Override
    public RpcEntityDefinition outputEntityDefinition() {
        return OpenAccountEntityHelper.outputEntityDefinition;
    }

    @NotNull
    @Override
    public JsonObject toJsonObject() {
        return OpenAccountEntityHelper.toJson(this);
    }

    @Override
    public void populateFromJson(@NotNull JsonObject jsonObject) {
        OpenAccountEntityHelper.populateFromJson(jsonObject, this);
    }
