...
@Getter
@Setter
@RpcEntity(name="Uactsql", language=Languages.DB2)
@RpcActions(actions = {
        @Action(action = EXECUTE.class, path = "DEMO001.UACTSQL", displayName = "Execute", alias = "execute" )            })
public class Uactsql implements org.openlegacy.core.rpc.RpcEntity {
    ...
    public RpcEntityDefinition entityDefinition() {
        return UactsqlEntityHelper.entityDefinition;
    }

    @NotNull
    @Override
    public RpcEntityDefinition inputEntityDefinition() {
        return UactsqlEntityHelper.inputEntityDefinition;
    }

    @NotNull
    @Override
    public RpcEntityDefinition outputEntityDefinition() {
        return UactsqlEntityHelper.outputEntityDefinition;
    }

    @NotNull
    @Override
    public JsonObject toJsonObject() {
        return UactsqlEntityHelper.toJson(this);
    }

    @Override
    public void populateFromJson(@NotNull JsonObject jsonObject) {
        UactsqlEntityHelper.populateFromJson(jsonObject, this);
    }
