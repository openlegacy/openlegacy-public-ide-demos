...
@Getter
@Setter
@RpcEntity(name="Gpolsql", language=Languages.DB2)
@RpcActions(actions = {
        @Action(action = EXECUTE.class, path = "DEMO001.GPOLSQL", displayName = "Execute", alias = "execute" )            })
public class Gpolsql implements org.openlegacy.core.rpc.RpcEntity {
    ...
    public RpcEntityDefinition entityDefinition() {
        return GpolsqlEntityHelper.entityDefinition;
    }

    @NotNull
    @Override
    public RpcEntityDefinition inputEntityDefinition() {
        return GpolsqlEntityHelper.inputEntityDefinition;
    }

    @NotNull
    @Override
    public RpcEntityDefinition outputEntityDefinition() {
        return GpolsqlEntityHelper.outputEntityDefinition;
    }

    @NotNull
    @Override
    public JsonObject toJsonObject() {
        return GpolsqlEntityHelper.toJson(this);
    }

    @Override
    public void populateFromJson(@NotNull JsonObject jsonObject) {
        GpolsqlEntityHelper.populateFromJson(jsonObject, this);
    }
