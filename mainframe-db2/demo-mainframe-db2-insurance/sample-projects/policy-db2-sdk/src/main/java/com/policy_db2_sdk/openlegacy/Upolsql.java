...
@Getter
@Setter
@RpcEntity(name="Upolsql", language=Languages.DB2)
@RpcActions(actions = {
        @Action(action = EXECUTE.class, path = "DEMO001.UPOLSQL", displayName = "Execute", alias = "execute" )            })
public class Upolsql implements org.openlegacy.core.rpc.RpcEntity {
    ...
    public RpcEntityDefinition entityDefinition() {
        return UpolsqlEntityHelper.entityDefinition;
    }

    @NotNull
    @Override
    public RpcEntityDefinition inputEntityDefinition() {
        return UpolsqlEntityHelper.inputEntityDefinition;
    }

    @NotNull
    @Override
    public RpcEntityDefinition outputEntityDefinition() {
        return UpolsqlEntityHelper.outputEntityDefinition;
    }

    @NotNull
    @Override
    public JsonObject toJsonObject() {
        return UpolsqlEntityHelper.toJson(this);
    }

    @Override
    public void populateFromJson(@NotNull JsonObject jsonObject) {
        UpolsqlEntityHelper.populateFromJson(jsonObject, this);
    }
